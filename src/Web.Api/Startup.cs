...
namespace Web.Api
{
  ...
  {
        //private const string SecretKey = "iNivDmHLpUA223sqsfhqGbMRdRj1PVkH"; // todo: chave privada para geração de token assimetrico
        private const string SecretKey = "avivatecTeste"; // todo: chave privada para geração de token assimetrico
    ...
    public IServiceProvider ConfigureServices(IServiceCollection services)
    {
      ...
      {
        c.SwaggerDoc("v1", new Info { Title = "TesteOn", Version = "v1" });
      });
    ...
    public void Configure(IApplicationBuilder app, IHostingEnvironment env)
    {
      ...
      app.UseSwaggerUI(c =>
      {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "TesteOn V1");
      });
